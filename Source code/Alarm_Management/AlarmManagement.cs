...
namespace Alarm_Management
{
    ...
    public class AlarmManagement
    {
        ...
        public static void AcknowledgeAlarm(int id1, int id2)
        {
            ...
            if (statusBefore != AlarmStatus.ACTIVE && statusBefore != AlarmStatus.INACTIVE)
            {
                logger.Error(Settings.Default.Error06);
                MyMessageBox.Show(Settings.Default.Error06);
                return;
            ...
            {
                logger.Error("ça n'est pas possible, je ne veux pas y croire");
                MyMessageBox.Show("ça n'est pas possible, je ne veux pas y croire");
            }
