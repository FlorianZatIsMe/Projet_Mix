...
<html>
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Main.Pages.Status">
  
  
  <h1 id="Main_Pages_Status" data-uid="Main.Pages.Status" class="text-break">Class Status
  </h1>
  <div class="markdown level0 summary"><p sourcefile="api/Main.Pages.Status.yml" sourcestartlinenumber="2">Logique d'interaction pour Status.xaml</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level7"><span class="xref">Status</span></div>
  </div>
  ...
  <h5 id="Main_Pages_Status_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class Status : Page, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="Main_Pages_Status__ctor_" data-uid="Main.Pages.Status.#ctor*"></a>
  <h4 id="Main_Pages_Status__ctor" data-uid="Main.Pages.Status.#ctor">Status()</h4>
  ...
  <h4 id="Main_Pages_Status_test" data-uid="Main.Pages.Status.test">test</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public int test</code></pre>
  </div>
